//Cretes an object to keep track of values.
const Calculator = {
...
function Input_Digit(digit){
   ...
   //This checks if the Wait_SEcond_Operand is true and sets Display_Value to the key 
   //that was clicked on.
   if (Wait_Second_Operand === true) {
    ...
    //This overwrites Display_Valie if the current value is 0
...
function Handle_Operator(Next_Operator){
    ...
    //we convert the current number displayed on the screen to a number and then store the result in
    //Calculator.First_Operator if it deosn't already exist.
    const Value_of_Input = parseFloat(Display_Value);
    //Checks if an operatior already exist and if Wait_Second_Operand is true,
    ...
    if (First_Operand == null){
        ...
        //If operatir exist, property lookup is performed for the operator
    ...
    //This function updates teh calculator screen with the contents of Display_Value
    function Update_Display(){
        //Makes use of teh calculator-screen class to target the input tag in the HTML
        //document
